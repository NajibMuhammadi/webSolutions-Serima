                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <AddressBlock
                                        icon={icon_1}
                                        title="Vår Adress"
                                        subtitle="Högbovägen 45 811 32 Sandviken"
                                    />
                                </div>
                                <div className="col-md-4">
                                    <AddressBlock
                                        ...
                                        subtitle='Du är varmt välkommen att kontakta oss! <br/><a href="tel:026-222 20 10" className="call text-lg fw-500">026-222 20 10</a>'
                                    />
                                </div>
                                <div className="col-md-4">
                                    <AddressBlock
                                        ...
                                        subtitle="Använd vårt kontaktformulär för att nå oss snabbt."
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-lg-5">
                                <div className="d-flex flex-column flex-lg-column-reverse">
                                    ...
                                    <div className="title-one text-center text-lg-start md-mt-20 mb-70 md-mb-30">
                                        <h2>
                                            Frågor eller funderingar? Hör gärna
                                            av dig!
                                        </h2>
                                    </div>
                                </div>
            ...
            <div className="map-banner mt-120 lg-mt-80">
                <div className="gmap_canvas h-100 w-100">
                    <iframe
                        ...
                        src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=sv&amp;q=Högbovägen 45 811 32 Sandviken&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                    ></iframe>
                </div>
            </div>
        </div>
